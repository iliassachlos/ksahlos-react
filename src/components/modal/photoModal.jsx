      ...
      <div className="fixed inset-0 z-10" data-aos="zoom-in">
         <div className="bg-[#F2F2F2] flex md:flex-row justify-between items-center p-12 w-full h-screen">
            <div className="w-full h-full relative">
               ...
               <div className={!isImageLoading ? "w-full h-full" : "hidden"}>{memoizedImage}</div>
               <AnimatePresence>
               ...
               <div className="absolute left-1/2 transform -translate-x-1/2 bottom-2 md:left-8 2xl:left-14 2xl:bottom-5">
